...
imageLayersHtml = "<img id='character' class='characterImg' src='soosh/sooshImg/" + base + ".png'>";
...
function imageAndButtonsHtmlMaker(sooshPart, sooshPartName) {
	...
	for (i=0; i<sooshPart.length; i++) {
		imageLayersHtml += "<img id='" + sooshPartName + i + "' class='characterImg " + sooshPartName + "' src='soosh/sooshImg/" + sooshPart[i][2] + ".png'>";
...
$(document).on('input', '#sooshSize', function() {
    $(".characterImg").css("width",$(this).val() + "px");
});
